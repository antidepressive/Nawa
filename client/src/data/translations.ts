export const translations = {
  ...
  ar: {
    ...
    "pitch.paragraph1":
      "تقف شركة نواة الأثر كمنظمة رائدة في تطوير الشباب السعودي، تربط الشركاء من القطاع الخاص ببرامج مؤثرة تشكل الجيل القادم من القادة والمبدعين.",
    "pitch.paragraph2":
      "من خلال مبادراتنا الثلاث الرئيسية - نواة المهنة، مؤتمرات نواة، ومؤسسة محاكاة الأمم المتحدة السعودية - أنشأنا نظاماً شاملاً يسد الفجوة بين التعليم والصناعة، ويعد الشباب السعودي لتحديات المستقبل.",
    "pitch.paragraph3":
