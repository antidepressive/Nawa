export const translations = {
  en: {
    ...
    "leadershipWorkshop.dateTimeValue": "2:00 PM - 8:00 PM",
    ...
    "leadershipWorkshop.venuePaymentWarning": "By choosing to pay at the venue, I acknowledge that I am not guaranteed a seat if there is no more space available. However, we will not accept payment at the venue unless we can actually accommodate you.",
  ...
  ar: {
    ...
    "leadershipWorkshop.dateTimeValue": "2:00 مساءً - 8:00 مساءً",
    ...
    "leadershipWorkshop.venuePaymentWarning": "باختيار الدفع في المكان، أقر بأنني لست مضموناً مقعداً إذا لم تكن هناك مساحة متاحة. ومع ذلك، لن نقبل الدفع في المكان إلا إذا كان بإمكاننا استيعابك فعلياً.",
